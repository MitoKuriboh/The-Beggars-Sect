      ...
      content: [
        ...
        },
        {
          ...
          lines: [
            ...
            { type: 'dialogue', speaker: 'VOICE (SCREAMING)', text: '"It\'s LOOSE! Subject 17 is breaking containment—"' },
            { type: 'pause', duration: 200 },
            { type: 'narration', text: 'Your chest ERUPTS with heat—not pain, but POWER.' },
            { type: 'narration', text: 'Everything INVERTS—light becomes shadow, up becomes down, forward becomes back.' },
            { type: 'effect', effect: { type: 'shake' } },
            { type: 'narration', text: 'Glass shatters. Alarms scream. Your chi flows BACKWARD through meridians.' },
            { type: 'internal', text: 'This is what I am. This WRONGNESS. This reversal.' },
            { type: 'effect', effect: { type: 'flash', color: 'black', duration: 300 } },
            { type: 'dialogue', speaker: 'VOICE (TERRIFIED)', text: '"The inverse flow—it\'s off the scale! EVACUATE—"' },
            { type: 'narration', text: 'Then—EXPLOSION.' },
            { type: 'narration', text: 'Not fire. Not force. Reality itself tears open.' },
            { type: 'pause', duration: 400 },
          ],
        },
        {
        ...
        {
          type: 'choice',
          prompt: 'In the dream, you try to grasp...',
          choices: [
            {
              id: 'remember-faces',
              label: 'The faces of those who did this',
              tag: 'Vengeful',
              response: [
                { type: 'internal', text: 'Who were they? I need to see their faces—' },
                { type: 'narration', text: 'The memory shifts. Masks. White coats. Eyes behind glass.' },
                { type: 'internal', text: 'No faces. They hid from me. From what they were doing.' },
                { type: 'narration', text: 'But you remember the FEELING. Clinical. Cold. Detached.' },
                { type: 'internal', text: 'They saw me as an experiment. Not a person.' },
              ],
              effects: [{ type: 'path', path: 'blade', delta: 1 }],
            },
            {
              id: 'focus-on-seventeen',
              label: 'The meaning of "Subject 17"',
              tag: 'Analytical',
              response: [
                { type: 'internal', text: 'Subject 17. Seventeen.' },
                { type: 'narration', text: 'The number echoes through the dream-memory.' },
                { type: 'internal', text: 'Seventeen failures before me. What happened to them?' },
                { type: 'narration', text: 'You see flashes—tables. Empty. One through sixteen.' },
                { type: 'narration', text: 'All empty. All failed.' },
                { type: 'internal', text: 'I was supposed to be different. But different how?' },
              ],
              effects: [{ type: 'path', path: 'shadow', delta: 1 }],
            },
            {
              id: 'feel-pendant',
              label: 'The warmth against your chest',
              tag: 'Intuitive',
              response: [
                { type: 'internal', text: 'Something warm. Even in the dream. Even in the memory.' },
                { type: 'narration', text: 'The pendant. You had it even then.' },
                { type: 'internal', text: 'They gave it to me? No. Someone else. Someone who helped me escape.' },
                { type: 'narration', text: 'A voice—female, desperate: "Run. Don\'t let them take you back."' },
                { type: 'internal', text: 'Who? Who helped me?' },
              ],
              effects: [{ type: 'path', path: 'stream', delta: 1 }],
            },
          ],
      ...
      content: [
        ...
        },
        {
          ...
          lines: [
            ...
            { type: 'narration', text: 'You grip it.' },
            { type: 'pause', duration: 300 },
            { type: 'narration', text: 'It RESPONDS.' },
            { type: 'effect', effect: { type: 'pendant-glow', intensity: 'bright' } },
            { type: 'narration', text: 'A pulse of warmth—no, RECOGNITION—floods through you.' },
            { type: 'narration', text: 'For one heartbeat, you remember EVERYTHING—' },
            { type: 'pause', duration: 400 },
            { type: 'narration', text: 'White rooms. Seventeen tables. Masked figures. A woman\'s desperate voice.' },
            { type: 'narration', text: '"Run. Don\'t let them take you back."' },
            { type: 'narration', text: 'Chi flowing backward through your body. Power. Terror. Freedom.' },
            { type: 'pause', duration: 400 },
            { type: 'narration', text: '—then it\'s gone.' },
            { type: 'effect', effect: { type: 'pendant-glow', intensity: 'faint' } },
            { type: 'narration', text: 'The memories slip away like water through your fingers.' },
            { type: 'internal', text: 'What... what was that?' },
            { type: 'pause', duration: 600 },
            { type: 'internal', text: 'The pendant knows who I am.' },
            { type: 'internal', text: 'Even if I don\'t.' },
            { type: 'pause', duration: 800 },
            { type: 'internal', text: 'I FELT it. Truth. Identity. Power.' },
            { type: 'internal', text: 'It\'s still there. Inside the pendant. Inside me.' },
            { type: 'internal', text: 'Waiting.' },
          ],
        },
        {
          type: 'content',
    ...
    // =========================================================================
    {
      ...
      content: [
        ...
        },
        {
          type: 'content',
          lines: [
            { type: 'system', text: 'COMBAT TUTORIAL: Your path shapes how you fight.' },
            { type: 'system', text: 'Your stance has been automatically chosen based on your choices so far.' },
            { type: 'system', text: 'Use ATTACK to strike. Use DEFEND to reduce damage. Watch the turn order on the right.' },
            { type: 'system', text: 'Later, you can learn to switch stances during combat for tactical advantage.' },
          ],
        },
        {
          type: 'combat',
        ...
        },
        {
          type: 'content',
          lines: [
            { type: 'narration', text: 'Your final palm strike connects.' },
            { type: 'pause', duration: 300 },
            { type: 'narration', text: 'The pendant FLARES against your chest—blazing hot.' },
            { type: 'effect', effect: { type: 'pendant-glow', intensity: 'intense' } },
            { type: 'narration', text: 'Your chi EXPLODES outward—but BACKWARD, flowing against nature.' },
            { type: 'pause', duration: 400 },
            { type: 'narration', text: 'The brawler flies back six feet. Crashes into the wall.' },
            { type: 'narration', text: 'Stone cracks behind him.' },
            { type: 'pause', duration: 500 },
            { type: 'dialogue', speaker: 'BRAWLER', text: '"What... what ARE you?!"', emotion: 'terrified' },
            { type: 'narration', text: 'His eyes are WIDE. Not with pain. With terror.' },
            { type: 'narration', text: 'He scrambles to his feet, bleeding, and runs.' },
            { type: 'dialogue', speaker: 'BRAWLER', text: '"Monster! MONSTER!"' },
            { type: 'pause', duration: 600 },
            { type: 'narration', text: 'Silence. Just your breathing.' },
            { type: 'effect', effect: { type: 'pendant-glow', intensity: 'faint' } },
            { type: 'narration', text: 'You look at your hands. Shaking now.' },
            { type: 'internal', text: 'I felt it. Just for a second.' },
            { type: 'internal', text: 'Something VAST inside me. Sleeping. Hungry.' },
            { type: 'pause', duration: 500 },
            { type: 'internal', text: 'The pendant flared when I struck.' },
            { type: 'internal', text: 'This power... where did it come from?' },
            { type: 'pause', duration: 600 },
            { type: 'internal', text: 'What AM I?' },
          ],
        },
        {
          type: 'choice',
      ...
      content: [
        ...
        },
        {
          ...
          lines: [
            ...
            { type: 'pause', duration: 500 },
            { type: 'narration', text: 'The world EXPLODES.' },
            { type: 'effect', effect: { type: 'pendant-glow', intensity: 'intense' } },
            { type: 'pause', duration: 600 },
            { type: 'narration', text: 'Your chi AWAKENS. Not gently. Like a dam breaking.' },
            { type: 'narration', text: 'You FEEL it—flowing through meridians you didn\'t know existed.' },
            { type: 'narration', text: 'For three heartbeats, you see EVERYTHING—' },
            { type: 'pause', duration: 800 },
            { type: 'narration', text: '—Chi flowing through the Lower Streets like invisible rivers of light—' },
            { type: 'narration', text: '—The Array\'s surveillance grid pulsing above like a spider\'s web—' },
            { type: 'narration', text: '—Old Dao\'s aura, VAST and ANCIENT, a sun disguised as a candle—' },
            { type: 'pause', duration: 800 },
            { type: 'internal', text: 'He\'s... he\'s...' },
            { type: 'pause', duration: 400 },
            { type: 'narration', text: 'Then it fades. The vision collapses.' },
            { type: 'effect', effect: { type: 'pendant-glow', intensity: 'faint' } },
            { type: 'narration', text: 'You gasp for air. Your legs buckle.' },
            { type: 'dialogue', speaker: 'OLD DAO', text: '"Ah. Yes. There you are."', emotion: 'satisfied' },
            { type: 'narration', text: 'You stare at him. This frail old man. This... POWER.' },
            { type: 'dialogue', speaker: 'LI WEI', text: '"What... what ARE you?"' },
            { type: 'dialogue', speaker: 'OLD DAO', text: '"A beggar. Like you will be."', emotion: 'amused' },
            { type: 'dialogue', speaker: 'LI WEI', text: '"That pendant—what is it?"' },
            { type: 'dialogue', speaker: 'OLD DAO', text: '"A key. A lock. A question and an answer. All at once."' },
            { type: 'internal', text: 'I saw it. The world beneath the world.' },
            { type: 'internal', text: 'Chi. Power. Systems I can\'t begin to understand.' },
            { type: 'internal', text: 'And Old Dao... he\'s not what he seems. Not even close.' },
          ],
        },
        {
          type: 'content',
    ...
    // =========================================================================
    {
      ...
      content: [
        ...
        },
        {
          type: 'content',
          lines: [
            { type: 'narration', text: 'Elder Chen places a hand on your shoulder.' },
            { type: 'dialogue', speaker: 'ELDER CHEN', text: '"We will teach you the beggar\'s way. Three stances. Three paths."' },
            { type: 'dialogue', speaker: 'ELDER WU', text: '"The Blade—break through obstacles with direct power."' },
            { type: 'dialogue', speaker: 'ELDER MEI', text: '"The Stream—turn force against itself through adaptation."' },
            { type: 'dialogue', speaker: 'ELDER CHEN', text: '"The Shadow—see what others miss through hidden truth."' },
            { type: 'pause', duration: 800 },
            { type: 'internal', text: 'I found them. A home. A family. A purpose.' },
            { type: 'internal', text: 'For the first time in... I don\'t know how long... I feel hope.' },
            { type: 'pause', duration: 1000 },
          ],
        },
        {
          type: 'content',
          lines: [
            { type: 'narration', text: 'Then—ALARM BELLS.' },
            { type: 'effect', effect: { type: 'shake' } },
            { type: 'narration', text: 'Bronze bells ring from somewhere above. Urgent. Panicked.' },
            { type: 'narration', text: 'The courtyard erupts into motion. Disciples scramble to defensive positions.' },
            { type: 'dialogue', speaker: 'ELDER WU', text: '"Everyone, defensive formation! NOW!"', emotion: 'commanding' },
            { type: 'pause', duration: 600 },
            { type: 'narration', text: 'The hidden door SLAMS open.' },
            { type: 'narration', text: 'A young disciple—bleeding from a head wound—staggers through.' },
            { type: 'dialogue', speaker: 'WOUNDED DISCIPLE', text: '"Elders! The Urban Thugs—they\'re attacking Guttermouth!"', emotion: 'desperate' },
            { type: 'dialogue', speaker: 'ELDER CHEN', text: '"How many?"' },
            { type: 'dialogue', speaker: 'WOUNDED DISCIPLE', text: '"Twenty. Maybe more. They\'re looking for someone."' },
            { type: 'narration', text: 'The disciple\'s eyes find you.' },
            { type: 'dialogue', speaker: 'WOUNDED DISCIPLE', text: '"A newcomer. With a jade pendant."' },
            { type: 'pause', duration: 1000 },
            { type: 'narration', text: 'Silence. Everyone turns to look at you.' },
            { type: 'internal', text: 'No. Not now. Not when I just found—' },
            { type: 'pause', duration: 600 },
            { type: 'narration', text: 'Old Dao materializes from the shadows.' },
            { type: 'dialogue', speaker: 'OLD DAO', text: '"So it begins. They found you faster than I hoped."' },
            { type: 'narration', text: 'He looks at you. His milky eyes somehow seeing everything.' },
            { type: 'dialogue', speaker: 'OLD DAO', text: '"Your first test comes tonight, Li Wei. The Calibration Initiative wants their Subject 17 back."' },
            { type: 'pause', duration: 800 },
            { type: 'internal', text: 'They\'re here. For me.' },
            { type: 'internal', text: 'Everyone I just met—they\'re in danger because of me.' },
            { type: 'pause', duration: 600 },
            { type: 'dialogue', speaker: 'ELDER CHEN', text: '"Li Wei. You are one of us now. We protect our own."' },
            { type: 'dialogue', speaker: 'ELDER WU', text: '"Time to see if you can fight, boy."', emotion: 'fierce' },
            { type: 'dialogue', speaker: 'ELDER MEI', text: '"Oh, this is going to be FUN!"', emotion: 'excited' },
            { type: 'pause', duration: 1000 },
            { type: 'narration', text: 'The alarm bells ring louder.' },
            { type: 'narration', text: 'Somewhere above, the thugs are getting closer.' },
            { type: 'narration', text: 'Your pendant pulses with heat against your chest.' },
            { type: 'internal', text: 'This is it. My first real test.' },
            { type: 'internal', text: 'Will I run? Or will I fight?' },
          ],
        },
        {
          type: 'content',
          lines: [
            ...
            { type: 'pause', duration: 1500 },
            { type: 'divider', label: 'YOUR JOURNEY BEGINS' },
            { type: 'narration', text: 'Li Wei awakened with no memory, only a pendant and fighting instincts.' },
            { type: 'narration', text: 'Five days of survival led him to Old Dao and the Beggars Sect.' },
            { type: 'narration', text: 'He found a home. A family. A purpose.' },
            { type: 'pause', duration: 1000 },
            { type: 'divider', label: 'BUT THE PAST DOESN\'T FORGET' },
            { type: 'narration', text: 'The Calibration Initiative has found Subject 17.' },
            { type: 'narration', text: 'Urban Thugs attack Guttermouth, hunting for the jade pendant.' },
            { type: 'narration', text: 'Li Wei must decide: Run and abandon his new family? Or fight and risk everything?' },
            { type: 'pause', duration: 1500 },
            { type: 'divider', label: 'QUESTIONS DEMAND ANSWERS' },
            { type: 'narration', text: '• What is Subject 17 and what happened to Subjects 1-16?' },
            { type: 'narration', text: '• Why does the Calibration Initiative want Li Wei back so badly?' },
            { type: 'narration', text: '• Who is the woman who helped him escape?' },
            { type: 'narration', text: '• What is inverse chi and why is it forbidden?' },
            { type: 'narration', text: '• Can Li Wei master the beggar\'s way before they come for him?' },
            { type: 'pause', duration: 2000 },
            { type: 'system', text: 'CHAPTER 1: STREETS OF THE FORGOTTEN' },
            { type: 'narration', text: 'The fight for survival continues...' },
            { type: 'pause', duration: 1000 },
            { type: 'system', text: '[ Full game unlocks the complete story ]' },
            { type: 'narration', text: 'Will you discover the truth about Li Wei\'s past?' },
            { type: 'narration', text: 'Will you master the three paths of the Beggars Sect?' },
            { type: 'narration', text: 'Will you survive the Calibration Initiative\'s hunt?' },
            { type: 'pause', duration: 1500 },
            { type: 'system', text: 'Your journey awaits in Chapter 1.' },
          ],
        },
      ],
