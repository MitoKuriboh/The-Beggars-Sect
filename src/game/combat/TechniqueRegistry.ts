...
const TECHNIQUES: Record<string, Technique> = {
  ...
  "palm-strike": {
    ...
    comboRole: "starter",
    comboLinks: [
      { techniqueId: "flowing-strike" },
      { techniqueId: "double-palm" },
    ],
  ...
  "flowing-strike": {
    ...
    comboRole: "followup",
    comboLinks: [
      { techniqueId: "finishing-palm" },
      { techniqueId: "double-palm" },
    ],
    description:
      "A smooth, continuous palm technique. Faster than basic attacks.",
    masteryBonuses: [
  ...
  "shattering-strike": {
    ...
    description:
      "A powerful strike that breaks through defenses. The first step on the Blade path.",
    philosophy:
      "Force overcomes all obstacles. Break their guard, then break them.",
    masteryBonuses: [
      {
        level: 2,
        usesRequired: 10,
        powerBonus: 2,
        effectBonus: "Armor break +5%",
      },
      {
        level: 3,
        usesRequired: 25,
        powerBonus: 4,
        effectBonus: "Armor break +10%",
      },
      {
        level: 4,
        usesRequired: 50,
        powerBonus: 6,
        effectBonus: "Armor break +15%, +1 turn",
      },
      {
        level: 5,
        usesRequired: 100,
        powerBonus: 8,
        effectBonus: "Guaranteed armor break",
      },
    ],
  ...
  "explosive-fist": {
    ...
    comboLinks: [],
    description:
      "Channel chi into a devastating explosive punch. Advanced Blade technique.",
  ...
  "calm-water-palm": {
    ...
    description:
      "Move like water - calm on the surface, powerful beneath. The foundation of Stream path.",
    philosophy:
      "Still water reflects truth. Flowing water shapes stone. Be both.",
    masteryBonuses: [
      {
        level: 2,
        usesRequired: 10,
        powerBonus: 1,
        effectBonus: "Chi restore +1",
      },
      {
        level: 3,
        usesRequired: 25,
        powerBonus: 2,
        effectBonus: "Chi restore +2",
      },
      {
        level: 4,
        usesRequired: 50,
        powerBonus: 3,
        effectBonus: "Chi restore +3",
      },
      {
        level: 5,
        usesRequired: 100,
  ...
  "whirlpool-counter": {
    ...
    description:
      "Draw the opponent in, then redirect their force. Advanced Stream technique.",
    ...
    masteryBonuses: [
      {
        ...
        usesRequired: 10,
        powerBonus: 2,
        effectBonus: "Counter damage +25%",
      },
      {
        level: 3,
        usesRequired: 25,
        powerBonus: 4,
        effectBonus: "Counter damage +50%",
      },
      {
        level: 4,
        usesRequired: 50,
        powerBonus: 6,
        effectBonus: "+1 counter turn",
      },
      {
        level: 5,
        usesRequired: 100,
        powerBonus: 8,
        effectBonus: "Perfect counters stun",
      },
    ],
    unlockedByDefault: false,
    unlockChapter: 1,
  ...
  "vital-point-strike": {
    ...
    description:
      "Strike the enemy's vital points with surgical precision. The essence of Shadow path.",
    philosophy:
      "One precise cut ends the battle. A thousand clumsy strikes waste time.",
    masteryBonuses: [
      { level: 2, usesRequired: 10, powerBonus: 2, effectBonus: "Debuff -5%" },
      {
        ...
        usesRequired: 25,
        powerBonus: 3,
        effectBonus: "Debuff -10%, +1 turn",
      },
      {
        level: 4,
        usesRequired: 50,
        powerBonus: 5,
        effectBonus: "Debuff -15%, +2 turns",
      },
      {
        level: 5,
        usesRequired: 100,
        powerBonus: 7,
        effectBonus: "Guaranteed critical hit",
      },
    ],
    unlockedByDefault: false,
    unlockRequirements: {
  ...
  "mist-step": {
    ...
    description:
      "Move like mist - unseen, untouchable, everywhere. Advanced Shadow technique.",
    ...
    masteryBonuses: [
      {
        ...
        usesRequired: 10,
        powerBonus: 0,
        effectBonus: "Evasion +10%",
      },
      {
        level: 3,
        usesRequired: 25,
        powerBonus: 0,
        effectBonus: "Evasion +20%, +1 turn",
      },
      {
        level: 4,
        usesRequired: 50,
        powerBonus: 0,
        effectBonus: "Next attack guaranteed crit",
      },
      {
        level: 5,
        usesRequired: 100,
        powerBonus: 0,
        effectBonus: "Invisibility (2 turns)",
      },
    ],
    unlockedByDefault: false,
    unlockChapter: 1,
  ...
  "finishing-palm": {
    ...
    comboLinks: [],
    description:
      "A powerful finisher that ends combos. Refunds chi on combo completion.",
    masteryBonuses: [
      { level: 2, usesRequired: 10, powerBonus: 3 },
      { level: 3, usesRequired: 25, powerBonus: 5 },
      { level: 4, usesRequired: 50, powerBonus: 7 },
  ...
  "weathered-guard": {
    ...
    masteryBonuses: [
      { level: 2, usesRequired: 10, powerBonus: 0, effectBonus: "Defense +5%" },
      {
        ...
        usesRequired: 25,
        powerBonus: 0,
        effectBonus: "Defense +10%, +1 turn",
      },
      {
        level: 4,
        usesRequired: 50,
        powerBonus: 0,
        effectBonus: "Defense +15%, +1 turn",
      },
      {
        level: 5,
        usesRequired: 100,
        powerBonus: 0,
        effectBonus: "Defense +20%, +1 turn, chi -2",
      },
    ],
    unlockedByDefault: false,
    unlockChapter: 1,
  ...
  "hungry-fang": {
    ...
    masteryBonuses: [
      ...
      { level: 4, usesRequired: 50, powerBonus: 5, effectBonus: "Heal +15%" },
      {
        ...
        usesRequired: 100,
        powerBonus: 7,
        effectBonus: "Heal always triggers",
      },
    ],
    unlockedByDefault: false,
    unlockChapter: 1,
    ...
    masteryBonuses: [
      {
        ...
        usesRequired: 10,
        powerBonus: 1,
        effectBonus: "Counter damage +20%",
      },
      {
        level: 3,
        usesRequired: 25,
        powerBonus: 2,
        effectBonus: "Counter damage +40%",
      },
      {
        level: 4,
        usesRequired: 50,
        powerBonus: 3,
        effectBonus: "Counter damage +60%",
      },
      {
        level: 5,
        usesRequired: 100,
        powerBonus: 5,
        effectBonus: "Perfect counter (stun)",
      },
    ],
    unlockedByDefault: false,
    unlockChapter: 1,
...
export function getStarterTechniques(techniqueIds: string[]): Technique[] {
  return techniqueIds
    .map((id) => TECHNIQUES[id])
    .filter(
      (t): t is Technique => t !== undefined && t.comboRole === "starter",
    );
}
...
export function getFinisherTechniques(techniqueIds: string[]): Technique[] {
  return techniqueIds
    .map((id) => TECHNIQUES[id])
    .filter(
      (t): t is Technique => t !== undefined && t.comboRole === "finisher",
    );
}
