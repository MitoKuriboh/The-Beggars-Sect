...
const ENEMY_TEMPLATES: Record<string, EnemyTemplate> = {
  ...
  "desperate-thug": {
    ...
    drops: [{ itemId: "coins", chance: 0.3, quantity: 2 }],
    dialogue: {
  ...
  "scarred-enforcer": {
    ...
    aiPattern: {
      ...
      rules: [
        ...
        {
          condition: "player.defending",
          action: "use:crushing-blow",
          priority: 1,
        },
  ...
  "spartan-grunt": {
    ...
    tier: "common",
    chiAspect: "armor",
    stats: { str: 8, dex: 10, end: 8, wis: 6 },
    speed: 115,
    defense: 4,
    techniques: ["baton-strike", "block", "restraint-hold"],
    aiPattern: {
      name: "BASIC_PATROL",
      behavior: "balanced",
      rules: [
        { condition: "hp < 50%", action: "defend", priority: 2 },
        {
          condition: "turn % 3 === 0",
          action: "use:restraint-hold",
          priority: 1,
        },
        { condition: "default", action: "use:baton-strike", priority: 0 },
      ],
    },
    drops: [
      { itemId: "bandage", chance: 0.3, quantity: 1 },
      { itemId: "coins", chance: 0.4, quantity: 15 },
    ],
    dialogue: {
      intro: ["Halt! Identify yourself!"],
      lowHp: ["Requesting backup..."],
      victory: ["Stand down, vagrant."],
      defeat: ["Target is... hostile..."],
    },
  },
  ...
  "spartan-recruit": {
    ...
    aiPattern: {
      ...
      rules: [
        ...
        {
          condition: "justDefended",
          action: "use:disciplined-thrust",
          priority: 1,
        },
  ...
  "initiative-soldier": {
    id: "initiative-soldier",
    name: "Initiative Soldier",
    chinese: "校准士兵",
    faction: "spartans", // Same faction mechanically - they're elite guards
    tier: "uncommon",
    chiAspect: "precision",
    stats: { str: 12, dex: 14, end: 12, wis: 10 },
    speed: 122,
    defense: 6,
    techniques: [
      "tactical-strike",
    ...
    aiPattern: {
      name: "INITIATIVE_TACTICAL",
      behavior: "tactical",
      rules: [
        { condition: "turn === 1", action: "use:suppress", priority: 3 },
        { condition: "hp < 50%", action: "defend", priority: 2 },
        {
          condition: "turn % 3 === 0",
          action: "use:coordinated-assault",
          priority: 1,
        },
        { condition: "default", action: "use:tactical-strike", priority: 0 },
      ],
    },
    drops: [
      { itemId: "bandage", chance: 0.4, quantity: 1 },
      { itemId: "swift-elixir", chance: 0.25, quantity: 1 },
      { itemId: "coins", chance: 0.5, quantity: 35 },
    ],
    dialogue: {
      intro: ["Target acquired. Engaging."],
      lowHp: ["Requesting tactical support..."],
      victory: ["Target neutralized."],
      defeat: ["Alert... high-value target..."],
    },
  },
  ...
  "agent-thorn": {
    ...
    tier: "rare",
    chiAspect: "precision",
    stats: { str: 16, dex: 18, end: 14, wis: 12 },
    speed: 130,
    defense: 7,
    techniques: [
      "thorn-strike",
    ...
    aiPattern: {
      ...
      behavior: "predator",
      rules: [
        { condition: "turn === 1", action: "use:shadow-bind", priority: 4 },
        {
          condition: "player.hp < 30%",
          action: "use:assassinate",
          priority: 3,
        },
        { condition: "hp < 40%", action: "use:smoke-bomb", priority: 2 },
        {
          condition: "turn % 3 === 0",
          action: "use:poison-needle",
          priority: 1,
        },
        { condition: "default", action: "use:thorn-strike", priority: 0 },
      ],
    },
    drops: [
      { itemId: "swift-elixir", chance: 0.5, quantity: 1 },
      { itemId: "iron-skin-salve", chance: 0.4, quantity: 1 },
      { itemId: "coins", chance: 0.6, quantity: 75 },
      { itemId: "technique-scroll", chance: 0.15, quantity: 1 },
    ],
    dialogue: {
      intro: [
        "The Initiative has been watching you, beggar. Your luck ends here.",
      ],
      lowHp: ["Impressive. But I have my orders."],
      victory: ["Another vagrant eliminated. Routine."],
      defeat: ["Commander Vex... will not be pleased..."],
    },
  },
  ...
  "wandering-fighter": {
    ...
    aiPattern: {
      ...
      rules: [
        {
          condition: "hp < 30% && !healed",
          action: "use:second-wind",
          priority: 3,
        },
        { condition: "chi > 20", action: "use:chi-burst", priority: 2 },
        {
          condition: "player.usedHeavyTechnique",
          action: "use:flowing-counter",
          priority: 1,
        },
  ...
  "silent-master": {
    ...
    aiPattern: {
      ...
      rules: [
        ...
        {
          condition: "hp < 50% && !meditated",
          action: "use:meditate",
          priority: 3,
        },
        { condition: "hp < 25%", action: "use:perfect-strike", priority: 2 },
        {
          condition: "chi > 25 && player.hp < 40%",
          action: "use:killing-intent",
          priority: 1,
        },
  ...
  "lone-wolf-disciple": {
    id: "lone-wolf-disciple",
    name: "Lone Wolf Disciple",
    chinese: "独狼弟子",
    faction: "lone-wolf",
    tier: "common",
    chiAspect: "flow",
    stats: { str: 10, dex: 12, end: 9, wis: 10 },
    speed: 118,
    defense: 4,
    techniques: ["swift-palm", "evasive-step", "chi-strike"],
    aiPattern: {
      name: "LONE_WOLF_DISCIPLE",
      behavior: "balanced",
      rules: [
        { condition: "hp < 40%", action: "use:evasive-step", priority: 2 },
        { condition: "chi > 15", action: "use:chi-strike", priority: 1 },
        { condition: "default", action: "use:swift-palm", priority: 0 },
      ],
    },
    drops: [
      { itemId: "spirit-tea", chance: 0.3, quantity: 1 },
      { itemId: "coins", chance: 0.4, quantity: 20 },
    ],
    dialogue: {
      intro: ["The mountain tests all who climb. Are you ready?"],
      lowHp: ["Your persistence... is admirable."],
      victory: ["Return when you've found your center."],
      defeat: ["The path continues upward..."],
    },
  },

  "lone-wolf-senior": {
    id: "lone-wolf-senior",
    name: "Lone Wolf Senior",
    chinese: "独狼前辈",
    faction: "lone-wolf",
    tier: "uncommon",
    chiAspect: "sense",
    stats: { str: 14, dex: 16, end: 12, wis: 14 },
    speed: 126,
    defense: 6,
    techniques: ["shadowless-palm", "flowing-counter", "chi-burst", "meditate"],
    aiPattern: {
      name: "LONE_WOLF_SENIOR",
      behavior: "tactical",
      rules: [
        {
          condition: "hp < 35% && !meditated",
          action: "use:meditate",
          priority: 3,
        },
        { condition: "chi > 25", action: "use:chi-burst", priority: 2 },
        {
          condition: "player.usedHeavyTechnique",
          action: "use:flowing-counter",
          priority: 1,
    ...
    drops: [
      { itemId: "spirit-tea", chance: 0.5, quantity: 1 },
      { itemId: "meditation-incense", chance: 0.4, quantity: 1 },
      { itemId: "coins", chance: 0.5, quantity: 50 },
      { itemId: "technique-scroll", chance: 0.12, quantity: 1 },
    ],
    dialogue: {
      intro: [
        "Few reach this height. Show me the strength of your conviction.",
      ],
      lowHp: ["Your chi... it resonates strangely. Who taught you?"],
      victory: ["The summit awaits another day."],
      defeat: ["The Hollow One awaits. Tell him... I said you were worthy."],
    },
  },
  ...
  razor: {
    ...
    aiPattern: {
      ...
      rules: [
        {
          condition: "turn === 1",
          action: "use:street-kings-authority",
          priority: 4,
        },
        { condition: "hp < 20%", action: "use:last-resort", priority: 3 },
        {
          condition: "hp < 50% && turn % 4 === 0",
          action: "use:desperate-fury",
          priority: 2,
        },
        {
          condition: "turn % 4 === 0",
          action: "use:brutal-combo",
          priority: 1,
        },
    ...
    dialogue: {
      intro: [
        "A beggar? In MY territory? Boys, teach this fool a lesson— wait, where are my boys?!",
      ],
  ...
  "commander-vex": {
    ...
    aiPattern: {
      ...
      rules: [
        {
          condition: "turn === 1",
          action: "use:analyze-opponent",
          priority: 5,
        },
        {
          condition: "hp < 30% && !prideBuff",
          action: "use:spartans-pride",
          priority: 4,
        },
        { condition: "hp < 15%", action: "use:final-command", priority: 3 },
        {
          condition: "turn % 3 === 0 && hp < 60%",
          action: "use:disciplined-assault",
          priority: 2,
        },
        {
          condition: "hp < 80% && !shielded",
          action: "use:shield-formation",
          priority: 1,
        },
    ...
    dialogue: {
      ...
      defeat: [
        "Impossible... defeated by a... No. You're no ordinary beggar. Who ARE you?",
      ],
      phase: {
        2: [
  ...
  "commander-vex-reduced": {
    id: "commander-vex-reduced",
    name: "Commander Vex",
    chinese: "维克斯指挥官",
    faction: "spartans",
    tier: "rare", // Not boss tier - reduced challenge for Stream path
    chiAspect: "precision",
    stats: { str: 14, dex: 14, end: 14, wis: 10 }, // Reduced stats
    speed: 122, // Slower
    ...
    drops: [
      { itemId: "coins", chance: 1.0, quantity: 200 },
      { itemId: "swift-elixir", chance: 0.8, quantity: 1 },
    ],
    dialogue: {
      intro: ["Your words have merit. But words alone won't save your sect."],
      lowHp: ["You... may not be like the other beggars..."],
      victory: ["Perhaps we both need to reconsider our positions."],
      defeat: ["Stand down, men. This one... isn't our enemy. Not today."],
    },
  },
  ...
  "the-hollow-one": {
    ...
    aiPattern: {
      ...
      rules: [
        {
          condition: "hp < 25% && !enlightened",
          action: "use:enlightenment",
          priority: 6,
        },
        { condition: "hp < 15%", action: "use:hollow-resonance", priority: 5 },
        {
          condition: "turn % 5 === 0 && hp < 40%",
          action: "use:perfect-form",
          priority: 4,
        },
        {
          condition: "player.chi > 30",
          action: "use:chi-disruption",
          priority: 3,
        },
        {
          condition: "turn % 4 === 0 && hp < 70%",
          action: "use:formless-strike",
          priority: 2,
        },
        {
          condition: "player.usedTechnique",
          action: "use:mirror-stance",
          priority: 1,
        },
    ...
    dialogue: {
      ...
      victory: ["你还不够...再来。"],
      defeat: [
        "终于...有人理解了。打狗棒...藏在山里。找到它...再来找我。我会等着。",
      ],
      phase: {
  ...
  "elder-mei-training": {
    id: "elder-mei-training",
    name: "Elder Mei (Sparring)",
    chinese: "梅长老（切磋）",
    faction: "beggars",
    tier: "common", // Training tier - not meant to be difficult
    chiAspect: "flow",
    stats: { str: 12, dex: 14, end: 12, wis: 16 },
    speed: 118,
    defense: 5,
    techniques: ["palm-strike", "flowing-strike", "elder-guidance", "chi-flow"],
    aiPattern: {
      ...
      rules: [
        {
          condition: "turn === 1",
          action: "use:elder-guidance",
          priority: 3,
        },
        {
          condition: "player.hp < 30%",
          action: "defend", // Gives player breathing room
          priority: 2,
        },
        { condition: "turn % 3 === 0", action: "use:chi-flow", priority: 1 },
        { condition: "default", action: "use:flowing-strike", priority: 0 },
      ],
    },
    drops: [], // Training - no loot
    dialogue: {
      intro: ["Good. Show me what you've learned, child."],
      lowHp: ["Excellent form! You're improving rapidly."],
      victory: ["Rest now. We'll continue tomorrow."],
      defeat: ["Well done! The sect's future is in good hands."],
    },
  },

  "elder-wu-training": {
    id: "elder-wu-training",
    name: "Elder Wu (Sparring)",
    chinese: "吴长老（切磋）",
    faction: "beggars",
    tier: "common",
    chiAspect: "sense",
    stats: { str: 10, dex: 16, end: 10, wis: 18 },
    speed: 124,
    defense: 4,
    techniques: ["shadow-step", "redirecting-palm", "chi-sense", "patience"],
    aiPattern: {
      name: "TRAINING_EVASIVE",
      behavior: "balanced",
      rules: [
        { condition: "turn === 1", action: "use:chi-sense", priority: 3 },
        {
          condition: "player.usedHeavyTechnique",
          action: "use:redirecting-palm",
          priority: 2,
        },
        { condition: "hp < 50%", action: "use:shadow-step", priority: 1 },
        { condition: "default", action: "use:patience", priority: 0 },
      ],
    },
    drops: [], // Training - no loot
    dialogue: {
      intro: ["The Shadow path requires patience. Let us see yours."],
      lowHp: ["Your instincts are sharpening. Good."],
      victory: [
        "Stealth is not about hiding. It's about knowing when to strike.",
      ],
      defeat: ["You move like smoke now. The shadows will serve you well."],
    },
  },

  "brother-feng-sparring": {
    id: "brother-feng-sparring",
    name: "Brother Feng (Sparring)",
    chinese: "风师兄（切磋）",
    faction: "beggars",
    tier: "common",
    chiAspect: "force",
    stats: { str: 14, dex: 10, end: 12, wis: 8 },
    speed: 105,
    defense: 5,
    techniques: ["heavy-palm", "iron-stance", "power-strike"],
    aiPattern: {
      name: "TRAINING_BLADE",
      behavior: "aggressive",
      rules: [
        { condition: "hp < 40%", action: "use:iron-stance", priority: 2 },
        {
          condition: "turn % 2 === 0",
          action: "use:power-strike",
          priority: 1,
        },
        { condition: "default", action: "use:heavy-palm", priority: 0 },
      ],
    },
    drops: [], // Training - no loot
    dialogue: {
      intro: ["The Blade path is about power and conviction. Show me yours!"],
      lowHp: ["Ha! You hit harder than you look!"],
      victory: ["Strength alone isn't enough. You need purpose behind it."],
      defeat: ["Now THAT'S the fire I was looking for! Good fight, junior!"],
    },
  },
  ...
  "brother-kang": {
    ...
    tier: "common",
    chiAspect: "flow",
    stats: { str: 11, dex: 13, end: 11, wis: 11 },
    speed: 112,
    defense: 4,
    techniques: ["palm-strike", "flowing-strike", "counter-stance"],
    aiPattern: {
      name: "TRAINING_BALANCED",
      behavior: "balanced",
      rules: [
        { condition: "hp < 35%", action: "use:counter-stance", priority: 2 },
        {
          condition: "turn % 3 === 0",
          action: "use:flowing-strike",
          priority: 1,
        },
        { condition: "default", action: "use:palm-strike", priority: 0 },
      ],
    },
    drops: [], // Training - no loot
    dialogue: {
      intro: ["A friendly spar, junior. Let's see how you've grown."],
      lowHp: ["Not bad! You're learning fast."],
      victory: ["Keep training. You'll get there."],
      defeat: ["Ha! The new blood is strong! Elder Mei chose well."],
    },
  },
};
...
export function createBoss(bossId: string): Enemy {
  ...
  if (!validBosses.includes(bossId)) {
    throw new Error(
      `Unknown boss: ${bossId}. Valid bosses: ${validBosses.join(", ")}`,
    );
  }
...
export function applyDifficultyScaling(
  ...
  (enemy as Enemy & { aiMistakeChance?: number }).aiMistakeChance =
    aiQuality.mistakeChance;
  (enemy as Enemy & { aiAggressiveness?: number }).aiAggressiveness =
    aiQuality.aggressiveness;
  (enemy as Enemy & { aiDefensiveness?: number }).aiDefensiveness =
    aiQuality.defensiveness;
}
